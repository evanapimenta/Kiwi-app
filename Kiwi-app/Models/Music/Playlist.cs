...
using Kiwi_app.Models.UserManagement;
...
internal class Playlist(User User)
{
    ...
    public User User { get; } = User ?? throw new ArgumentNullException(nameof(Playlist.User), "User cannot be null");
    ...
    private List<Track> _playlistTracks = new();
    ...
    public static int GenerateUniquePlaylistId()
    {
        ...
        lock (lockObject)
        {
            ...
            } while (!AddPlaylistId(newPlaylistId));
        }
