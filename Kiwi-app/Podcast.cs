...
namespace Kiwi_app
{
    ...
    internal class Podcast(Host Host, string PodcastName)
    {
        ...
        public string PodcastName { get; } = PodcastName ?? throw new ArgumentNullException(nameof(PodcastName), "Podcast name cannot be null");
        public HashSet<Episode> Episodes { get; } = new();
        public int EpisodeNumber => Episodes.Count;
        public List<int> PodcastRatings { get; } = new();
        public double PodcastAverageRating => PodcastRatings.Average();
        ...
        public static int GenerateUniquePodcastId()
        {
            ...
            lock (lockObject)
            {
                ...
                } while (!Podcast.AddPodcastId(newPodcastId));
            }
